...
export default function Home() {
  ...
  <p className={styles.parables}>
        ...
        <iframe width="100%" height="315" src="https://www.youtube.com/embed/ak06MSETeo4?autoplay=1&mute=2" title="YouTube video player" frameborder="1" allow="accelerometer; &autoplay=1 clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>                  
